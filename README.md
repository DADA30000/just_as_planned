...
Lightning fast Rust rewrite of https://github.com/Failzuma/JustAsPlanned (yes, 95% is vibecoded, I'm sorry, just wanted to see if Gemini 3.0 could make it faster, and well, it did, soI just didn't want to rewrite something AI did perfectly fine :P)
